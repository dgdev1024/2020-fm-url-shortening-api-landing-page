...
function SvgIllustrationWorking(props) {
  return (
    <svg width={733} height={482} {...props}>
      <defs>
        <linearGradient
          id="illustration-working_svg__a"
          x1="0%"
          x2="100%"
          y1="50%"
          y2="50%"
        ...
        <linearGradient
          id="illustration-working_svg__b"
          x1="-.13%"
          x2="100%"
          y1="50.057%"
          y2="50.057%"
        ...
        <linearGradient
          id="illustration-working_svg__c"
          x1="176.072%"
          x2="310.393%"
          y1="-566.037%"
          y2="-534.629%"
        ...
        <linearGradient
          id="illustration-working_svg__d"
          x1="58.928%"
          x2="52.269%"
          y1="-257.998%"
          y2="-277.344%"
        ...
        <linearGradient
          id="illustration-working_svg__e"
          x1="156.099%"
          x2="8.109%"
          y1="-63.273%"
          y2="-76.114%"
        ...
        <linearGradient
          id="illustration-working_svg__f"
          x1="2361.044%"
          x2="2162.651%"
          y1="-16584.906%"
          y2="-16647.547%"
        ...
        <linearGradient
          id="illustration-working_svg__g"
          x1="241.391%"
          x2="133.142%"
          y1="-426.052%"
          y2="-412.195%"
        ...
        <linearGradient
          id="illustration-working_svg__h"
          x1="106.85%"
          x2="-35.821%"
          y1="22.502%"
          y2="19.27%"
        ...
        <linearGradient
          id="illustration-working_svg__i"
          x1="14.169%"
          x2="114.168%"
          y1="-41.335%"
          y2="-41.335%"
        ...
        <linearGradient
          id="illustration-working_svg__j"
          x1="40.386%"
          x2="71.43%"
          y1="39.515%"
          y2="67.977%"
        ...
        <linearGradient
          id="illustration-working_svg__k"
          x1="-12.531%"
          x2="93.689%"
          y1="44.923%"
          y2="53.42%"
        ...
        <linearGradient
          id="illustration-working_svg__l"
          x1="53.702%"
          x2="43.721%"
          y1="42.271%"
          y2="80.595%"
        ...
        <linearGradient
          id="illustration-working_svg__m"
          x1="190.926%"
          x2="102.154%"
          y1="-333.246%"
          y2="-335.028%"
        ...
        <linearGradient
          id="illustration-working_svg__n"
          x1="168.578%"
          x2="111.53%"
          y1="-126.252%"
          y2="-126.942%"
        ...
        <linearGradient
          id="illustration-working_svg__o"
          x1="56.989%"
          x2="28.128%"
          y1="43.618%"
          y2="69.958%"
        ...
        <linearGradient
          id="illustration-working_svg__p"
          x1="58.095%"
          x2="57.212%"
          y1="-1473.571%"
          y2="-1370.204%"
        ...
        <linearGradient
          id="illustration-working_svg__q"
          x1="-.04%"
          x2="99.996%"
          y1="49.993%"
          y2="49.993%"
        ...
        <linearGradient
          id="illustration-working_svg__r"
          x1="99.032%"
          x2="199.03%"
          y1="-163.287%"
          y2="-163.287%"
        ...
        <linearGradient
          id="illustration-working_svg__s"
          x1="124.306%"
          x2="224.306%"
          y1="-84.564%"
          y2="-84.564%"
        ...
        <linearGradient
          id="illustration-working_svg__t"
          x1="128.89%"
          x2="24.06%"
          y1="100.36%"
          y2="153.095%"
        ...
        <linearGradient
          id="illustration-working_svg__u"
          x1="3990.942%"
          x2="3874.36%"
          y1="-34225.187%"
          y2="-34268.317%"
      ...
      <g fill="none">
        ...
        <path
          fill="url(#illustration-working_svg__a)"
        ...
        />
        <path
          fill="url(#illustration-working_svg__d)"
        ...
        />
        <path
          fill="url(#illustration-working_svg__e)"
        ...
        />
        <path
          fill="url(#illustration-working_svg__f)"
          d="M264 388a7.624 7.624 0 01-2 2 119.75 119.75 0 002-2z"
        />
        <path
          fill="url(#illustration-working_svg__g)"
        ...
        />
        <path
          fill="url(#illustration-working_svg__h)"
          d="M122.664 434.601l11.73.399v-93.745s.59-24.241 23.452-26.673c22.861-2.431 230.196-32.466 230.196-32.466s8.218-.87 12.951 14.901c4.733 15.771 9.34 77.787 9.34 77.787l63.64 8.577s1.68-109.55-21.302-115.595c-22.981-6.045-323.522 24.76-323.522 24.76s-22.29 116.352-6.485 142.055z"
          opacity={0.197}
        />
        <path
        ...
        />
        <path
          fill="url(#illustration-working_svg__i)"
        ...
        />
        <path
          fill="url(#illustration-working_svg__j)"
          d="M267 259.38l.57 2.114s16.881 10.173 16.775 10.501c-.106.328 70.024-16.24 70.024-16.24L356 251l-89 8.38z"
        />
        <path
          fill="#2BD0D0"
        ...
        />
        <path
          fill="url(#illustration-working_svg__k)"
          d="M268 259.364L330.107 246 356 251.054 285.442 268z"
        />
        <path
          fill="#2BD0D0"
        ...
        />
        <path
          fill="url(#illustration-working_svg__l)"
          d="M247.832 270.484l14.457.512s3.672.228 4.62-2.717c.95-2.945-5.89-9.16-6.622-9.277-.733-.118-19.76 5.22-17.017 10.556l4.562.926z"
        />
        <path
          fill="#2BD0D0"
        ...
        />
        <path
          fill="url(#illustration-working_svg__m)"
          d="M79 416.056l-7.058 21.677c-20.473 7.351-37.88 0-37.88 0L29 415s25.535 8.56 50 1.056z"
        />
        <path
          fill="#2BD0D0"
        ...
        />
        <path
          fill="url(#illustration-working_svg__n)"
          d="M87 396l-2.284 16.943-5.786 3.008c-24.648 7.42-50.415-1.038-50.415-1.038l-4.443-3.283L22 396h65z"
        />
        ...
        <ellipse
          cx={54.5}
          cy={395}
          fill="url(#illustration-working_svg__o)"
          rx={32.5}
          ry={6}
        />
        <path
        ...
        />
        <path
          fill="url(#illustration-working_svg__p)"
        ...
        />
        <path
          fill="url(#illustration-working_svg__q)"
        ...
        />
        <path
          fill="url(#illustration-working_svg__r)"
        ...
        />
        <path
          fill="url(#illustration-working_svg__s)"
        ...
        />
        <path
          fill="url(#illustration-working_svg__t)"
          d="M469.804 212.337l-142.25 7.655c-3.44.177-6.372-2.478-6.554-5.934V112.473c-.004-4.102 3.26-7.452 7.342-7.535l141.68-2.937c3.777-.07 6.898 2.943 6.978 6.738v95.977c-.005 4.057-3.164 7.403-7.196 7.621z"
        />
        <path
          fill="#3A3054"
        ...
        />
        <path
          fill="url(#illustration-working_svg__u)"
...
export default SvgIllustrationWorking;
